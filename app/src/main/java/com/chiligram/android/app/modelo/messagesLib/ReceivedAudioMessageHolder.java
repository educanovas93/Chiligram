...
public class ReceivedAudioMessageHolder extends RecyclerView.ViewHolder {

    TextView timeText, duracion,nameText;
    ...
    public ReceivedAudioMessageHolder(View itemView) {
        ...
        seekBar = (SeekBar) itemView.findViewById(R.id.seekbar_rec);
